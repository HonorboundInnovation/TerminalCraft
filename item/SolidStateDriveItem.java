...
public final class SolidStateDriveItem extends Item {
    ...
    public static String label(ItemStack stack) {
        ...
        SolidStateDriveTier tier = tier(stack);
        return tier == null ? "ssd" : tier.id() + "-ssd";
    }
    ...
    public Component getName(ItemStack stack) {
        ...
        SolidStateDriveTier drive = tier(stack);
        if (drive == null || label.equals(drive.id() + "-ssd")) return Component.literal(name);
        return Component.literal(name + " (" + label + ")");
    }
}
